...
namespace API.DAta.Migrations
{
    ...
    [Migration("20250413140712_1toManyBussUserApp")]
    partial class _1toManyBussUserApp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SuvatGatewayBackend.Entities.AppUser", b =>
                {
                    b.HasOne("SuvatGatewayBackend.Entities.AppBusiness", "AppBusiness")
                        .WithMany("Users")
                        .HasForeignKey("AppBusinessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppBusiness");
                });
